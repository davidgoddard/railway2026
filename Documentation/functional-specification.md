...
The preview and initial provisioning transport is a separate setup path. It must permit images without making continuous images part of the ESP-NOW state path. Closing previews must have no effect on normal monitoring.
