...
const events = ['bridge:state', 'bridge:notice', 'bridge:error', 'bridge:event', 'bridge:state-event', 'bridge:cell-state-event', 'bridge:mqtt', 'bridge:progress', 'bridge:frame', 'bridge:network-event', 'bridge:request-result', 'bridge:diagnostic', 'monitor:status', 'monitor:message', 'monitor:removed'];
